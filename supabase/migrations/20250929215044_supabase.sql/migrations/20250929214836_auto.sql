...
DROP FUNCTION "public"."can_admin_projects"();

-- HAS_UNTRACKABLE_DEPENDENCIES: Dependencies, i.e. other functions used in the function body, of non-sql functions cannot be tracked. As a result, we cannot guarantee that function dependencies are ordered properly relative to this statement. For drops, this means you need to ensure that all functions this function depends on are dropped after this statement.
DROP FUNCTION "public"."create_project_submission"(p_name text, p_description text, p_lead_org_id uuid, p_lat double precision, p_lng double precision, p_place_name text, p_type_of_intervention text[], p_target_demographic text, p_lives_improved integer, p_start_date date, p_end_date date, p_thematic_area text[], p_donations_received numeric, p_amount_needed numeric, p_currency text, p_links jsonb, p_partner_org_ids uuid[], p_sdg_ids integer[], p_ifrc_ids integer[]);
...
ALTER TABLE "public"."projects" ADD CONSTRAINT "pgschemadiff_tmpnn_qhq9UyVYSB2uuWGGEYp5yQ" CHECK("status" IS NOT NULL) NOT VALID;

ALTER TABLE "public"."projects" VALIDATE CONSTRAINT "pgschemadiff_tmpnn_qhq9UyVYSB2uuWGGEYp5yQ";

ALTER TABLE "public"."projects" ADD COLUMN "approval_status" project_approval_status DEFAULT 'pending'::project_approval_status NOT NULL;
...
ALTER TABLE "public"."projects" ALTER COLUMN "thematic_area" SET DATA TYPE text COLLATE "pg_catalog"."default" using "thematic_area"::text;
...
ANALYZE "public"."projects" ("thematic_area");

ALTER TABLE "public"."projects" ADD COLUMN "title" text COLLATE "pg_catalog"."default" NOT NULL;
...
ALTER TABLE "public"."projects" ALTER COLUMN "status" SET DEFAULT 'planned'::text;

ALTER TABLE "public"."projects" ADD CONSTRAINT "projects_status_check" CHECK((status = ANY (ARRAY['planned'::text, 'active'::text, 'completed'::text]))) NOT VALID;

ALTER TABLE "public"."projects" VALIDATE CONSTRAINT "projects_status_check";

ALTER TABLE "public"."projects" DROP CONSTRAINT "pgschemadiff_tmpnn_qhq9UyVYSB2uuWGGEYp5yQ";
