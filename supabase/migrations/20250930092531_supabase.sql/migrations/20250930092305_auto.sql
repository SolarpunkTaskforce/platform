...
ALTER TABLE "public"."projects" ADD CONSTRAINT "pgschemadiff_tmpnn_OBiCXJKVTN68lqHf9K_YDw" CHECK("status" IS NOT NULL) NOT VALID;

ALTER TABLE "public"."projects" VALIDATE CONSTRAINT "pgschemadiff_tmpnn_OBiCXJKVTN68lqHf9K_YDw";
...
ALTER TABLE "public"."projects" DROP CONSTRAINT "pgschemadiff_tmpnn_OBiCXJKVTN68lqHf9K_YDw";
